...
class WorkoutCardOld extends StatefulWidget {
  WorkoutCardOld(this.workout);

  final FredericWorkout workout;

  @override
  _WorkoutCardOldState createState() => _WorkoutCardOldState();
}

class _WorkoutCardOldState extends State<WorkoutCardOld> {
