...
class CircleLoadingProgressSpinnerPainter extends CustomPainter {
  final double percentage;
  final double strokeWidth;
  final Color backgroundColor;
  final Color foregroundColor;

  CircleLoadingProgressSpinnerPainter({
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    final oldPainter = (oldDelegate as CircleLoadingProgressSpinnerPainter);
